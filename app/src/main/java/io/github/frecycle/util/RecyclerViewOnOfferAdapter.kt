...
class RecyclerViewOnOfferAdapter() : RecyclerView.Adapter<RecyclerViewOnOfferAdapter.MyViewHolder>() {
    ...
    class MyViewHolder : RecyclerView.ViewHolder {
        ...
        constructor(itemView: View, listener: OnItemClickListener) : super(itemView){
            productCoverImage = itemView.findViewById(R.id.imageViewProductOnOffer)
            this.progressBar = itemView.findViewById(R.id.progressBar4OnOfferItem)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        ...
        val view: View = inflater.inflate(R.layout.snippet_cardview_item_on_offer, parent,false)
